...
function optimizer_customizer_stuff() {
			...
			foreach ($presets as $preset) { ?>
               ...
               <img src="<?php echo get_template_directory_uri(); ?>/assets/images/presets/preset<?php echo $preset;?>.jpg" title="Preset <?php echo $preset;?>" />
                <div class="preset_buttons_wrap">
                	<a href="http://optimizer.layerthemes.com/demo<?php echo $preset;?>/" target="_blank" class="preset_demo"><i class="fa-eye"></i> <?php _e('Demo','optimizer'); ?></a>
		...
		<?php } ?>
            ...
            <div id="footlinks">
            	...
            	<a class="optim_docs" target="_blank" href="https://www.layerthemes.com/optimizer-documentation/" title="<?php _e('Documentation', 'optimizer'); ?>"><i class="fa fa-book"></i></a>
    	...
    	<div class="back_header">
            <div class="center">
                ...
                <div class="support_btns">
                    ...
                    <a href="https://www.layerthemes.com/support/theme/optimizer/" target="_blank" class="pro_support"><?php _e('PRO Support','optimizer'); ?><span><?php _e('24/7 Instant Support','optimizer'); ?></span></a>
                </div>
           </div> 
       </div>
        <div class="blocks_wrap">
        	<div class="center">
                ...
                <div class="block">
                    ...
                    <a href="https://www.layerthemes.com/optimizer-documentation/" target="_blank"  class="backend_btn"><?php _e('Documentation','optimizer'); ?></a>
                </div>
                <!--BLOCK 3-->
                <div class="block">
                    ...
                    <a href="https://www.layerthemes.com/theme/optimizer-upgrade/" target="_blank"  class="backend_btn"><?php _e('Upgrade','optimizer'); ?></a>
                </div> 
