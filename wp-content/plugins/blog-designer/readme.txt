...
> * Show/Hide Post category, tags, author, comment count, etc.
...
2. Blog Designer by 'Classical Desgin' theme layout
3. Blog Designer by 'Light Breeze Design' theme layout
4. Blog Designer by 'Spektrum Design' theme layout
